...
<body>
    <header>
        <nav class="navegacao">
            ...
            <div class="links">
                <a href="cadastro_aluno.html">Cadastro</a>
                <a href="../php/filtro.php">Pesquisa</a>
            </div>
        </nav>
    </header>
    <main>
        <div class="container">
            ...
            <section class="container_forms">
                <h2>Editar Aluno</h2>
                <form action="../php/form_aluno.php" method="post">
                    <div class="cadastro_aluno">
                        <label for="nome">NOME COMPLETO:</label>
                        <input type="text" name="nome" id="nome" required />
                    </div>
                    <div class="cadastro_aluno">
                        <label for="cpf">CPF :</label><input type="text" name="cpf" id="cpf" required maxlength="14" />
                    </div>
                    <div class="cadastro_aluno">
